$(document).ready(function () {
	...
	$(".animated-text-effect").typed({ 
		...
		strings: ["TOT - Travel On Time^","TOT - Travel On Time^"], // example for multiple headings strings: ["Awesome Ineractive Effect^", "Click on the live effect!^", "Coolest Modern HTML Theme^"], 
		contentType: "text", 
		typeSpeed: 30, 
		loop: true, 
		backDelay: 1200, 
