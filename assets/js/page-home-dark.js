$(document).ready(function () {
	...
	$(".animated-text-effect").typed({ 
		...
		strings: ["Cloud First Strategy^", "Journey to Cloud^", "Cloud Management & Optimization^", "Cloud for Retail^", "Robotics & Automation^", "Internet of Things^", "Innovate at Speed^", "Accelerate Your Business^", "Unleash Your Potential With Cloud^"], 
		contentType: "text", 
		typeSpeed: 30, 
		loop: true, 
		backDelay: 1200, 
