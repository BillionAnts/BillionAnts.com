...
define('COMPANY_NAME',    "Billion Ants");          // not required, but recommended
define('YOUR_EMAIL',      "contact@billionants.com");  // * Required, your email address, for example my-email@gmail.com
define('EMAILS_SUBJECT',  "New Form Submission - BillionAnts.com");   // * Required, email subject
...
define("RECAPTCHA_V3_SECRET_KEY", '6LfsknIbAAAAALex0F_EfCrglviFlYPMH42adwaz'); // recaptcha version 3 SECRET_KEY
